...
function NFTDropPage({collection}: Props) {
    ...
    const minNft=()=>{
        ...
        const quantity = 1; //how many nft you can claim
        setLoading(true);
  ...
  <div className="flex h-screen flex-col lg:grid lg:grid-cols-10">
    ...
    <div className="lg: col-span-4 bg-gradient-to-br from-cyan-800 to-rose-500">
        <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
            <div className="rounded-xl bg-gradient-to-br from-yellow-400 to-purple-600 p-2">
                <img className="w-44 rounded-xl object-cover lg:96 lg:w-72" src={urlFor(collection.previewImage).url()} alt="" />
            </div>
    ...
    <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <Link href={'/'}><h1 className="w-52 cursor-pointer text-xl font-extralight sm:w-80">The <span className="font-extrabold underline decoration-pink-600/50"> Shandy </span>{' '} NFT Market Place</h1></Link>
        ...
        disabled={loading || claimedSupply === totalSupply?.toNumber()|| !address} className="h-16 bg-red-600 w-full text-white rounded-full mt-10 font-bold disabled:bg-gray-400">
        {loading ? (
            <>Loading</>
